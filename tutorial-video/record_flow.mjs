...
const RAW_DIR = path.join(ROOT_DIR, 'hyperframes-showcase/assets/raw_recordings');
const CLIPS_DIR = path.join(ROOT_DIR, 'hyperframes-showcase/assets/video_clips');
...
async function recordSpritePoses(browser) {
  ...
  // Clic en Guardar mapa provisional
...
async function recordTileMap(browser) {
  ...
  // Mover cursor a través de las opciones de transición
